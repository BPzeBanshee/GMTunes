if surface_exists(surf) 
    ...
    var ww = (surface_get_width(surf)/2) * surf_scale;
    var hh = (surface_get_height(surf)/2) * surf_scale;
    image_xscale = ww;
    image_yscale = hh;
    ...
    draw_surface_ext(surf,xx,yy,surf_scale,surf_scale,direction,c_white,1);
