...
spr_logo1 = -1;
spr_logo2 = -1;
var f1 = game_save_id+"TUNERES.DAT_ext/MaxKids.bmp";
var f2 = game_save_id+"TUNERES.DAT_ext/IwaiLogo.bmp";
var tmp;
if file_exists(f1) 
	{
	tmp = bmp_load(f1);
	spr_logo1 = sprite_create_from_surface(tmp,0,0,640,480,false,false,0,0);
	}
if file_exists(f2) 
	{
	tmp = bmp_load(f2);
	spr_logo2 = sprite_create_from_surface(tmp,0,0,640,480,false,false,0,0);
	}
...
then buffer_set_surface(bmp_buffer,surf,0)
else 
	{
